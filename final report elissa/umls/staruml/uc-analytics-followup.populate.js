/* Paste into the StarUML console (Debug > Show DevTools > Console) after opening uc-analytics-followup.mdj
   and double-clicking the diagram under the Model node. It draws:
     - a titled system-boundary rectangle "LeadDesk — Analytics and Smart Follow-Up" (UMLUseCaseSubject: no folder tab),
...
(function () {
  const BOUNDARY_TITLE = "LeadDesk — Analytics and Smart Follow-Up";
