/* Paste into the StarUML console (Debug > Show DevTools > Console) after opening uc-account-management.mdj
   and double-clicking the diagram under the Model node. It draws:
     - a titled system-boundary rectangle "LeadDesk — Account Management" (UMLUseCaseSubject: no folder tab),
...
(function () {
  const BOUNDARY_TITLE = "LeadDesk — Account Management";
