/* Paste into the StarUML console (Debug > Show DevTools > Console) after opening uc-sprint4.mdj
...
(function () {
  const SUBJECT = "Assistant and Live Integration";
  const BOX = { x: 240, y: 60, w: 540, h: 470 };
  const UC_POS = {
  "Authenticate": {
    "x": 280,
    "y": 120
