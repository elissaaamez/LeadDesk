/* Paste into the StarUML console (Debug > Show DevTools > Console) after opening uc-authentication.mdj
   and double-clicking the diagram under the Model node. It draws:
     - a titled system-boundary rectangle "LeadDesk — Authentication" (UMLUseCaseSubject: no folder tab),
...
(function () {
  const BOUNDARY_TITLE = "LeadDesk — Authentication";
  const BOX = { x: 260, y: 70, w: 340, h: 570 };
  const UC_POS = {
  "Create account": {
    "x": 305,
    "y": 135
