/* Paste into the StarUML console (Debug > Show DevTools > Console) after opening uc-platform-foundation.mdj
   and double-clicking the diagram under the Model node. It draws:
     - a titled system-boundary rectangle "LeadDesk — Platform Foundation" (UMLUseCaseSubject: no folder tab),
...
(function () {
  const BOUNDARY_TITLE = "LeadDesk — Platform Foundation";
  const BOX = { x: 260, y: 70, w: 340, h: 475 };
  const UC_POS = {
  "Navigate pages": {
    "x": 305,
    "y": 135
