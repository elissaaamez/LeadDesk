/* Paste into the StarUML console (Debug > Show DevTools > Console) after opening uc-lead-capture.mdj
   and double-clicking the diagram under the Model node. It draws:
     - a titled system-boundary rectangle "LeadDesk — Lead Capture and Duplicate Detection" (UMLUseCaseSubject: no folder tab),
...
(function () {
  const BOUNDARY_TITLE = "LeadDesk — Lead Capture and Duplicate Detection";
  const BOX = { x: 260, y: 70, w: 340, h: 665 };
  const UC_POS = {
