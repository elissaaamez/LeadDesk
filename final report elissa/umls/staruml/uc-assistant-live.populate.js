/* Paste into the StarUML console (Debug > Show DevTools > Console) after opening uc-assistant-live.mdj
   and double-clicking the diagram under the Model node. It draws:
     - a titled system-boundary rectangle "LeadDesk — CRM Assistant and Live Integration" (UMLUseCaseSubject: no folder tab),
...
(function () {
  const BOUNDARY_TITLE = "LeadDesk — CRM Assistant and Live Integration";
  const BOX = { x: 260, y: 70, w: 590, h: 570 };
  const UC_POS = {
  "Ask the assistant": {
    "x": 305,
    "y": 135
